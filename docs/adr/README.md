...
| ADR | Decision | Status |
| --- | --- | --- |
| [0001](0001-mvp-scope.md) | MVP scope and release boundaries | Accepted |
| [0002](0002-canonical-job-model.md) | Canonical job and posting model | Accepted |
| [0003](0003-side-effect-authority.md) | External side-effect authority chain | Accepted |
| [0004](0004-google-oauth-scopes.md) | Google OAuth, Gmail and Calendar scopes | Accepted |
